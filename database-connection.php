...
$db       = 'cleuteri_pictures';    // Name of the database
$port     = '3306';                           // Port is usually 3306 in Hostgator
$charset  = 'utf8mb4';                       // UTF-8 encoding using 4 bytes of data per char

$username = 'cleuteri_cleuteritz16';     // Enter YOUR cPanel username and user here
$password = 'cleuteritz16!';           // Enter YOUR user password here                                     
